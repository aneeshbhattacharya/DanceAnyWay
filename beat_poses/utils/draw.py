...
class Plotter3d:
    SKELETON_EDGES = np.array([[11, 10], [10, 9], [9, 0], [0, 3], [3, 4], [4, 5], [0, 2], [2,6], [6, 7], [7, 8], [2, 12],
...
body_edges = np.array(
    ...
    [0,2], [2,6], [6,7], [7,8], #neck - root - l_hip - l_knee - l_ankle
    [2,12], [12,13], [13,14] #root - r_hip - r_knee - r_ankle
