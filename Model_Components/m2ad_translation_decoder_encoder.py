...
class Translation_Decoder(nn.Module):
    def __init__(self,args):
        ...
        self.aff_encoder = AffEncoder(12)
        self.in_size = 12
...
class Translation_SeqGenerator(nn.Module):
    ...
    def forward(self, hidden_enc, cell_enc, pose_sequences, target):
        ...
        for t in range(1, target.shape[1]):
            output, hidden, cell = self.decoder(input, hidden * 0.6 + hidden_enc * 0.4, cell_enc)
